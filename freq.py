...
path = 'E:/ACADEMICS/Assignments/Year III/NET311/data/text/assign.txt'
...
if not os.path.exists(os.path.abspath(path) + 'frequency_report1.txt'):
    with open('frequency_report1.txt','w') as freq:
